...
if __name__ == "__main__":
    ...
    for archivo in archivos:
        ...
        cv2.putText(copia, f"Tubería 1: {distancia_valor(v_modal_tub1)}% / {estados[deteccion1]}", (tuberia1[2], tuberia1[0]-10), cv2.FONT_HERSHEY_COMPLEX, .8, colores_posibles[colores[deteccion1]], 2)
        cv2.putText(copia, f"Tubería 2: {distancia_valor(v_modal_tub2)}% / {estados[deteccion2]}", (tuberia2[2], tuberia2[0]-10), cv2.FONT_HERSHEY_COMPLEX, .8, colores_posibles[colores[deteccion2]], 2)
